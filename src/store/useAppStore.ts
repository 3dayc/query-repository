...
interface AppState {
    ...
    incrementSharedSessionVersion: () => void;
...
export const useAppStore = create<AppState>((set, get) => ({
    ...
    incrementSharedSessionVersion: () => set((state) => ({ sharedSessionVersion: state.sharedSessionVersion + 1 })),
